...
def get_client_detail(request, client_id: int):
    ...
    return 200, {
        ...
        "contact_person": client.contact_person or None,
        "contact_email": client.contact_email or None,
        "contact_phone": client.contact_phone or None,
        "industry_type": client.industry_type or None,
        "brand_logo": client.brand_logo.url if client.brand_logo else None,
        "facebook_url": client.facebook_url or None,
        "instagram_url": client.instagram_url or None,
        "youtube_url": client.youtube_url or None,
        "linkedin_url": client.linkedin_url or None,
        "twitter_url": client.twitter_url or None,
        "tiktok_url": client.tiktok_url or None,
        "preferred_post_time": client.preferred_post_time.strftime('%H:%M') if client.preferred_post_time else None,
        "created_at": client.created_at,
        "updated_at": client.updated_at,
    }
